...
class  FieldBool extends Field{
    ...
    */
    static function create($name, $_formTypeId, $type="bool", $category=false)
    {
       //call the parent create
       return parent::create($name, $_formTypeId, "bool", false);
    }
    ...
    */
    static function delete($name)
    {
        ...
        //delte the values
        FModel::$db->delete("field_bool", "_field_id = " . $id);
    ...
    */
    static function save($fieldId , $value, $label="N/A"){  
        ...
        FModel::$db->insert("field_bool", array("value" => $value, "_field_id" => $fieldId, "label" => $label));
        return FModel::$db->lastInsertId("field_bool_id_seq");
    }

    
    static function getValue($fieldValueId){
        $data = FModel::$db->select("select value, label from field_bool where id = :id",
    ...
    static function deleteValue($id){
        FModel::$db->delete("field_bool", "id = ". $id);
    }
    
    static function update($valueId, $data, $label = 'N/A'){
        FModel::$db->update("field_bool", array(
            "value"=>$data,
            "label" => $label
        ), "id = $valueId");
    }
